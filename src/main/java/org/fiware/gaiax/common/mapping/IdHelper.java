package org.fiware.gaiax.common.mapping;


import org.fiware.gaiax.common.CommonConstants;
...
public class IdHelper {
	...
	public static URI toNgsiLd(String id, @Context String targetType) {
		return URI.create(String.format(CommonConstants.ID_TEMPLATE, targetType, Optional.ofNullable(id).orElse(UUID.randomUUID().toString())));
	}
